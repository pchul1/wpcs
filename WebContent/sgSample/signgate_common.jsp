...
<%!
	...
	public static final String CRLCacheDirectory = "/data/signgate/SG_SecuKit/cert/crl";
	public static final String ServerCertPath = "/data/signgate/SG_SecuKit/cert/";
...
<script language='javascript' src='./sg_scripts/sg_basic.js' charset="utf-8"></script>
<script language='javascript' src='./sg_scripts/sg_error.js' charset="utf-8"></script>
<script language='javascript' src='./sg_scripts/sg_util.js' charset="utf-8"></script>
<script language='javascript' src='./sg_scripts/sg_cert.js' charset="utf-8"></script>
<script language='javascript' src='./sg_scripts/sg_sign.js' charset="utf-8"></script>
<script language='javascript' src='./sg_scripts/sg_encrypt.js' charset="utf-8"></script>
<script language='javascript' src='./sg_scripts/sg_pkcs7.js' charset="utf-8"></script>
<script language='javascript' src='./sg_scripts/sg_hash.js' charset="utf-8"></script>
<script language='javascript' src='./sg_scripts/sg_base64.js' charset="utf-8"></script>
