...
<style>
	td, input { font-size: 12px; font-family:tahoma; }
	.btn { padding-top:2px; width:100px; }
</style>
	<center>
		<strong>
			<font color="blue" size="4">인증서 기반 로그인</font>
		</strong>
	</center><br>
...
<form name="input_form" method="POST" onsubmit="return false">
	<table>
		...
		<tr><td>
			...
			<input type="text"	name="UserSSN"	value="" size="30">
		</td></tr>
	</table>
	...
	<% if("update".equals(mode)) { %>
	<input type="button"	value="인증서등록"	OnClick="javascript:do_login()" class="btn">
	<% } else { %>
	<input type="button"	value="로그인"	OnClick="javascript:do_login()" class="btn">
	<input type="button"	value="인증서등록"	OnClick="location.href='LoginForm.jsp?mode=update'" class="btn">
	<% } %>
	</div>
</form>
