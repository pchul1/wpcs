...
<%-- 
    Document   : xchart
    Created on : Jun 25, 2008, 8:12:35 PM
...
<html>
    ...
    <body>
        ...
        TextProvider txtProvider = new TextProvider(application.getRealPath("/") + "/data/statistical_data_spc.txt");
        chart1.setDataSource(txtProvider);
        chart1.setGalleryAttributes(statistics1.getGallery().getXChart());
        statistics1.getLegendBox().setVisible(true);
      

        statistics1.getGallery().getXChart().setSigma(Double.NaN);
