...
chart1.getSeries().get(0).setColor(new java.awt.Color(0,0,255,128));
chart1.getSeries().get(1).setColor(new java.awt.Color(0,255,0,128));

Radar gallery = (Radar) chart1.getGalleryAttributes();
gallery.setShowLines(false);
chart1.getAllSeries().setMarkerSize((short)5);
