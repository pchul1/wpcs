...
try
{
	...
	Statement stmt=null;
	sql  = "SELECT OBJECTID, WH_CODE, WH_NAME, ADMIN_MGR, ADMIN_SUB_, ADMIN_TELN, LON AS X, LAT AS Y, CTY_CODE, USE_FLAG, HOUSE_TYPE FROM GIS_WAREHOUSE WHERE  USE_FLAG = 'Y' ";
