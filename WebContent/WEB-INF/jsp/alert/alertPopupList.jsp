...
<%
	 ...
	 * 2014.11.21  mypark 	그리드 걷어내고 테이블 처리
	 * 
	 * author khany
	 * since 2010.05.17
	 * 
			...
			success:function(result){
				...
				if( tot <= 0 ){
					...
					for(var i=0; i < tot; i++){
						...
						dataHtml += "<td>" + obj.sendDate +"</td>";
						dataHtml += "<td>" + obj.part +"</td>";
						dataHtml += "<td>" + obj.name +"</td>";
						dataHtml += "<td>" + obj.telNo +"</td>";
						dataHtml += "<td>" + obj.gubun +"</td>";
						dataHtml += "<td>" + obj.susin +"</td>";
						dataHtml += "<td>" + obj.smsMsg +"</td>";
						dataHtml += "</tr>";
					}
				}
...
<body>
	...
	<div id="wrap">
		...
		<!-- Body Start-->
			<!--tab Contnet Start-->
			<div class="tab_container" style="width:990px;margin:30px auto;">
				...
				<div class="table_wrapper">
					<table summary="게시판 목록. 번호, 발송시간, 소속, 성명, 전화번호, 유형, 수신여부, 전송메세지가 담김">
						<colgroup>
							<col width="45" />
							<col width="120" />
							<col width="130" />
