...
function goSubmit(){
	...
	obj.action = "/alert/addressFileUpload.do";
	obj.submit();
}
</script>
</head>
...
<div style="margin:20px;height:100%;">
	<form id="form1" action="" name="form1" method="post" enctype="multipart/form-data">
		<input type="hidden" name="atchFileId" value="${param.atchFileId }"/>
		<input type="hidden" name="fileSn"     value="${param.fileSn }"/>
		...
		<table style="text-align:left" summary="관리자정보">
			...
			<tr>
				<th>비상연락망 파일 <span class="red">*</span></th>
				<td>
