...
<div id="wrap">
	<div class="header">
		<h1 class="logo"><img src="<c:url value='/images/center/h1_logo.gif'/>" alt="수질오염방제센터" /></h1>
	</div> 
	<div class="container">
		<div class="content_title">
			<h2 class="tit"><img src="<c:url value='/images/center/h_join_tit.gif'/>" alt="계정신청" /></h2>
		</div>
		<div class="content">
 ...
 -->				
					...
					<tr>
						...
						<td colspan="3">
							...
							@
							<label for="email1" class="hidden">E.mail 나머지 입력</label> 
							<span title="첫번째 이메일 입력" alt="첫번째 이메일 입력"><form:input path="email1"/></span>
							<label for="email2" class="hidden">E.mail 나머지 입력2</label> 
