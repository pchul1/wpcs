...
$(function(){
	...
	$("#river_div").change(function() { 
		$("#dataList").html("<tr><td colspan='6'><span>데이터를 불러옵니다...</span></td></tr>");
		refresh();
		mapMove();
	});
...
function getItemDropDownAll()
{
	...
	$.getJSON("<c:url value='/common/code/getCode.do'/>", {codeGbn:itemCode}, function (data, status){
	     if(status == 'success'){     
...
function refresh(){
	...
	$.ajax({
		...
		success:function(result){
            ...
            $("#dataList").html("");
            if( tot <= "0" ){
				$("#dataList").html("<tr><td colspan='6'><span>조회 결과가 없습니다</span></td></tr>");
				...
				item = "<tr class='"+trClass+"' code='"+obj.fact_code+"' branchNo='"+obj.branch_no+ "' style='cursor:pointer;'" + 
									"onclick=\"javascript:mapMoveBranch('"+obj.latitude+"', '" + obj.longitude + "')\">"
									+"<td>"+obj.river_name+"</td>"
									+"<td>"+obj.fact_name+"</td>"
									+"<td>"+branchName+"</td>"
									+"<td id='or"+i+"' class='num'><span>" + ((obj.min_vl == "") ? "-" : obj.min_vl)+ "</span></td>"
									+"<td>"+obj.sys_kind+"</td>"
        ...
        error:function(result){
			$("#dataList").html("<tr><td colspan='6'>서버 접속 실패!</td></tr>");
	    }
	});
}
...
function refreshR01(){
	...
	$.ajax({
		...
		success:function(result){
            ...
            $("#dataListR01").html("");
            if( tot <= "0" ){
				$("#dataListR01").html("<tr><td colspan='4'><span>조회 결과가 없습니다</span></td></tr>");
...
function showAlga()
{
	$.getJSON("<c:url value='/waterpolmnt/waterinfo/getRecentAlga.do'/>", function (data, status){
		if(status == 'success'){
			...
			if(algaData == null || algaData.survey_time == undefined)
				text += "&nbsp;&nbsp;&nbsp;<b>[조류예보]</b> 이상없음 ";
			else
				text += "&nbsp;&nbsp;&nbsp;<b>[조류예보]</b>&nbsp;수계: <font color='gray'>"+river+ 
						"</font> &nbsp;일자: <font color='gray'>" + date + 
						"</font> &nbsp;pH: <font color='gray'>" + ph + 
						"</font> &nbsp;클로로필a: <font color='gray'>" + chla + 
						"</font> &nbsp;남조류: <font color='gray'>" + cyan + "</font>";
			*/
...
// 			if(airData == null || airData.flight_date == undefined)
// 				test += "&nbsp;&nbsp;&nbsp;<b>[항공감시]</b> 이상없음 ";
// 			else	
// 				text += "&nbsp;&nbsp;&nbsp;<b>[항공감시]</b> &nbsp;비행구간: <font color='gray'>"+river+ 
// 							"</font> &nbsp;일자: <font color='gray'>" + date + 
// 							"</font> &nbsp;호기: <font color='gray'>" + plane + 
// 							"</font> &nbsp;환경 항공 감시 결과: <font color='gray'>" + note + "</font>";
...
function loadAlertStepList(){
	 ...
	 $("#alertDataList").html("");
	$("#alertDataList").html("<tr><td colspan='5'>데이터를 불러오고 있습니다.</td></td>");
	
	$.ajax({
		type:"post",
		url:"<c:url value='/alert/alertStepListView.do'/>",
		data:{riverId:"All", minTime:"", system:"All"},
		dataType:"json",
		success:function(result){
            ...
            if( tot <= "0" ){
            	$("#alertDataList").html("<tr><td colspan='5'>조회 결과가 없습니다</td></td>");
            }else{
                for(var i=0; i < tot; i++){
                    ...
                    if(obj.alertStep == "1") {
                   	...
                   	item = "<tr class='"+trClass+"'>" 
	                   	 +"<td id='rem"+i+"'>"+obj.factName+"</td>"
		                 +"<td id='rem"+i+"'>"+obj.branchNo+"측정소</td>"
	                  	 +"<td id='rem"+i+"'>"+obj.minOr+"</td>"
	                     +"<td id='rem"+i+"'>"+item+"</td>"		
	                     +"<td style='cursor:pointer;'" + 
							"onclick=\"alertList_popup('"+obj.factCode+"', '" + obj.branchNo + "')\"><img src=\"<c:url value='/images/popup/icon_view.gif'/>\" alt='측정소상황전파자정보' /></td>"
                   	item = item +"</tr>";                       	
...
function alertList_popup(factCode, branchNo) {
	...
	window.open("<c:url value='/waterpolmnt/situationctl/goTotalmntpopAlertList.do'/>?factCode="+factCode + "&branchNo=" + branchNo, 
			'alertList','width='+winWidth+',height='+winHeight+',toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,left='+winLeftPost+',top='+winTopPost);
}
...
<div id="wrap" class="mainPop"> 
	<div class="pop_header">
		<div class="bg_header_r">
			<div class="bg_header">
				<h1 class="pop_tit"><img src="<c:url value='/images/popup/h1_construct_totalmnt.gif'/>" alt="4대강공사 통합감시" /></h1>
	...
	<div id="container" class="pop_total_other"> 
		<!-- content -->
     				...
     				<div class="notes_weather">
	                    <div class="notesWrap">
	  						...
	  						<p class="txt">
						        ...
						        <img src="<c:url value='/images/content/ico_a.gif'/>" alt="A" /> <span>국가수질자동측정망</span>
							</p>
						</div>
						...
						<div class="list_wrap">
							<div class="part_wrap">
								<div class="header_box">
									<p class="btn"><a href="#" onclick="showHideCon(1)" id="btn_content1" class="open"><img src="<c:url value='/images/popup/btn_arrow_up.gif'/>" alt="close" /></a></p>
									<h2>
									...
									<p class="weather" id='weatherR01' onclick="weather_popup('R01')"><span id='weatherSqR01'></span><img id='weatherImgR01' src="<c:url value='/images/common/ajax-loader.gif'/>" alt="" /><span id="weatherForecastR01">-</span></p> 
								</div>
							...
							<div class="part_wrap">
								<div class="header_box">
									<p class="btn"><a href="#" onclick="showHideGraph(1)" id="btn_graph1" class="open"><img src="<c:url value='/images/popup/btn_arrow_up.gif'/>" alt="close" /></a></p>
									<h2>수질 변화 추이</h2>
								</div>
								<div class="graph" id="graph1">
									<div style="position:absolute;">
										<img id="chartImg1" src="<c:url value='/images/common/btn_enlarge.gif' />" alt="" />
										<span id='chartLoading1' style="display:none">로딩중 입니다...</span>
									</div>
									<iframe frameborder="0" marginheight="0" marginwidth="0" id="chart1" width="264px" height="99px" scrolling="no"></iframe>							
								</div>
							</div>
							<div class="part_wrap">
								<div class="header_box tit_data">
									<h2>측정소별 측정값</h2>
								</div>
...
<!-- 												<option value="T">탁수모니터링</option>  -->
									...
									<table class="dataTable title_table" oncontextmenu="return false" ondragstart="return false" onselectstart="return false"> 
										<colgroup> 
											<col width="30px" /> 
											<col width="80px" /> 
											<col width="60px" /> 
									...
									<div class="overBox" id="overBox1">
										<table class="dataTable con_table" oncontextmenu="return false" ondragstart="return false" onselectstart="return false"> 
											<colgroup> 
												<col width="30px" /> 
												<col width="80px" /> 
												<col width="60px" /> 
...
<!-- 												<option value="T">탁수모니터링</option>  -->
									...
									<div class="overBox" id="overBox1_1"> 
										<table class="dataTable conTable" oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
											<colgroup>
												<col width="40px" />
												<col width="30px" />
												<col width="60px" />
						...
						<div class="list_wrap">
							<div class="part_wrap">
								<div class="header_box">
									<p class="btn"><a href="#" onclick="showHideCon(3)" id="btn_content3" class="open"><img src="<c:url value='/images/popup/btn_arrow_up.gif'/>" alt="close" /></a></p>
									<h2><a href="javascript:manager_popup('R03');">금강</a></h2>
									<p class="weather" id='weatherR03' onclick="weather_popup('R03')"><span id='weatherSqR03'></span><img id='weatherImgR03' src="<c:url value='/images/common/ajax-loader.gif'/>" alt="" /><span id="weatherForecastR03">-</span></p> 
								</div>
							...
							<div class="part_wrap">
								<div class="header_box">
									<p class="btn"><a href="#" onclick="showHideGraph(3)" id="btn_graph3" class="open"><img src="<c:url value='/images/popup/btn_arrow_up.gif'/>" alt="close" /></a></p>
									<h2>수질 변화 추이</h2>
								</div>
								<div class="graph" id="graph3">
									<div style="position:absolute;">
										<img id="chartImg3" src="<c:url value='/images/common/btn_enlarge.gif' />" alt="" />
										<span id='chartLoading3' style="display:none">로딩중 입니다...</span>
									</div>
									<iframe frameborder="0" marginheight="0" marginwidth="0" id="chart3" width="264px" height="99px" scrolling="no"></iframe>							
								</div>
							</div>
							<div class="part_wrap">
								<div class="header_box tit_data">
...
<!-- 												<option value="T">탁수모니터링</option>  -->
						...
						<div class="list_wrap">
							<div class="part_wrap">
								<div class="header_box">
									<p class="btn"><a href="#" onclick="showHideCon(2)" id="btn_content2" class="open"><img src="<c:url value='/images/popup/btn_arrow_up.gif'/>" alt="close" /></a></p>
									<h2><a href="javascript:manager_popup('R02');">낙동강</a></h2>
									<p class="weather" id='weatherR02' onclick="weather_popup('R02')"><span id='weatherSqR02'></span><img id='weatherImgR02' src="<c:url value='/images/common/ajax-loader.gif'/>" alt="" /><span id="weatherForecastR02">-</span></p> 
								</div>
							...
							<div class="part_wrap">
								<div class="header_box">
									<p class="btn"><a href="#" onclick="showHideGraph(2)" id="btn_graph2" class="open"><img src="<c:url value='/images/popup/btn_arrow_up.gif'/>" alt="close" /></a></p>
									<h2>수질 변화 추이</h2>
								</div>
								<div class="graph" id="graph2">
									<div style="position:absolute;">
										<img id="chartImg2" src="<c:url value='/images/common/btn_enlarge.gif' />" alt="" />
										<span id='chartLoading2' style="display:none">로딩중 입니다...</span>
									</div>
									<iframe frameborder="0" marginheight="0" marginwidth="0" id="chart2" width="264px" height="99px" scrolling="no"></iframe>							
								</div>
							</div>
							<div class="part_wrap">
								<div class="header_box tit_data">
...
<!-- 												<option value="T">탁수모니터링</option>  -->
						...
						<div class="list_wrap list_last">
							<div class="part_wrap">
								<div class="header_box">
									<p class="btn"><a href="#" onclick="showHideCon(4)" id="btn_content4" class="open"><img src="<c:url value='/images/popup/btn_arrow_up.gif'/>" alt="close" /></a></p>
									<h2><a href="javascript:manager_popup('R04');">영산강</a></h2>
									<p class="weather" id='weatherR04' onclick="weather_popup('R04')"><span id='weatherSqR04'></span><img id='weatherImgR04' src="<c:url value='/images/common/ajax-loader.gif'/>" alt="" /><span id="weatherForecastR04">-</span></p> 
								</div>
							...
							<div class="part_wrap">
								<div class="header_box">
									<p class="btn"><a href="#" onclick="showHideGraph(4)" id="btn_graph4" class="open"><img src="<c:url value='/images/popup/btn_arrow_up.gif'/>" alt="close" /></a></p>
									<h2>수질 변화 추이</h2>
								</div>
								<div class="graph" id="graph4">
									<div style="position:absolute;">
										<img id="chartImg4" src="<c:url value='/images/common/btn_enlarge.gif' />" alt="" />
										<span id='chartLoading4' style="display:none">로딩중 입니다...</span>
									</div>
									<iframe frameborder="0" marginheight="0" marginwidth="0" id="chart4" width="264px" height="99px" scrolling="no"></iframe>							
								</div>
							</div>
							<div class="part_wrap">
								<div class="header_box tit_data">
...
<!-- 												<option value="T">탁수모니터링</option>  -->
						...
						<script type="text/javascript">
							...
							function showHideCon(idx){
								var btn_content = document.getElementById("btn_content" + idx);
								var contentArea = document.getElementById("list_content" + idx);
								var btn_graph = document.getElementById("btn_graph" + idx);
								var graphArea = document.getElementById("graph" + idx);
								var overBox = document.getElementById("overBox" + idx).style;
								...
								if(btn_content.className == "open"){
									...
									if(btn_graph.className == "open"){
										overBox.height = "386px";
									}else{
									...
									btn_content.getElementsByTagName("img")[0].src = btn_content.getElementsByTagName("img")[0].src.replace("_down.gif'/>","_up.gif'/>");
									btn_content.getElementsByTagName("img")[0].alt = "close";
									contentArea.style.display = "";

									if(btn_graph.className == "open"){
										overBox.height = "235px";
									}else{
										overBox.height = "346px";
									}
								}
							...
							function showHideGraph(idx){
								...
								if(btn_graph.className == "open"){
									btn_graph.className = "close";
									btn_graph.getElementsByTagName("img")[0].src = btn_graph.getElementsByTagName("img")[0].src.replace("_up.gif'/>","_down.gif'/>");
									btn_graph.getElementsByTagName("img")[0].alt = "open";
									...
									btn_graph.className = "open";
									btn_graph.getElementsByTagName("img")[0].src = btn_graph.getElementsByTagName("img")[0].src.replace("_down.gif'/>","_up.gif'/>");
									btn_graph.getElementsByTagName("img")[0].alt = "close";
...
<!-- 							<li><a href="" id='flowData' target="_blank" title="새창" ></a></li>  -->
<!-- 						</ul>  -->
<!-- 					</div> -->
					<div class="layer_data_box1"  id="layer_data_box1" style="visibility:hidden">
						<div id="layerBtn1con" class="con">
							<div class="header">
								<p>금일 사고 접수 및 처리 현황</p>
							</div>
							<div class="dataBox">
								<table class="dataTable titleTable" oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
									<colgroup>
										<col width="" />
										<col width="" />
										<col width="" />
						...
						<div class="btn">
							<a href="#" id="layerBtn1"><img src="<c:url value='/images/popup/btn_layer_right.gif'/>" alt="open" /></a>
						</div>
					</div>
					<div class="layer_data_box2"  id="layer_data_box2" style="visibility:hidden">
						<div class="btn">
							<a href="#" id="layerBtn2"><img src="<c:url value='/images/popup/btn_layer_left.gif'/>" alt="open" /></a>
						</div>
						<div id="layerBtn2con" class="con">
							<div class="mapWrap">
								<div class="mapBox">
					...
					<script type="text/javascript">
						var layerBtn1 = document.getElementById("layerBtn1");
						var layerBtn1Img = layerBtn1.getElementsByTagName("img")[0];
						var layerBtn1con = document.getElementById("layerBtn1con");
						
						var layerBtn2 = document.getElementById("layerBtn2");
						var layerBtn2Img = layerBtn2.getElementsByTagName("img")[0];
						var layerBtn2con = document.getElementById("layerBtn2con");  
						
						var h2Tit = document.getElementById("h2Tit").style;
						var h3Tit1 = document.getElementById("h3Tit1").style;
						var h3Tit2 = document.getElementById("h3Tit2").style;
					    var h2Select = document.getElementById("river_div").style;
					    var overBox1_1 = document.getElementById("overBox1_1").style;

						var btn_content = document.getElementById("btn_content1");
						var contentArea = document.getElementById("list_content1");
						var btn_graph = document.getElementById("btn_graph1");
						var graphArea = document.getElementById("graph1");
						var overBox = document.getElementById("overBox1").style;
					    

						layerBtn1.onclick = function(){
							if(layerBtn1Img.alt == "close"){
								layerBtn1con.style.display = "none";
								layerBtn1Img.src = layerBtn1Img.src.replace("_left","_right");
								layerBtn1Img.alt = "open";
								return false;
							}else if(layerBtn1Img.alt == "open"){
								layerBtn1con.style.display = "";
								layerBtn1Img.src = layerBtn1Img.src.replace("_right","_left");
								layerBtn1Img.alt = "close";
								return false;
							}
						}

						layerBtn2.onclick = function(){
							if(layerBtn2Img.alt == "close"){
								layerBtn2con.style.display = "none";
								layerBtn2Img.src = layerBtn2Img.src.replace("_right","_left");
								layerBtn2Img.alt = "open";
								h2Tit.display = "";
							    h2Select.display = "none";
								h3Tit1.display = "";
								h3Tit2.display = "none";
								...
								return false;
							}else if(layerBtn2Img.alt == "open"){
								layerBtn2con.style.display = "";
								layerBtn2Img.src = layerBtn2Img.src.replace("_left","_right");
								layerBtn2Img.alt = "close"; 
								h2Tit.display = "none";
						        h2Select.display = "";
								h3Tit1.display = "none";
								h3Tit2.display = "";
								overBox1_1.height = "497px";
