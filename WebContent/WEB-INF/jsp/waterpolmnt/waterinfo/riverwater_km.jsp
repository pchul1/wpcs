...
<%
	/**
	 * Class Name : riverwater_km.jsp
	 * Description : 금호강 일대 수질정보 모델링 조회 화면
...
<script type="text/javascript">
	...
	function popModeling() {
		var frDate = $("#startDate").val2();
		window.open("/psupport/hourData.html?toDate="+frDate+"&stdItem=TON00&viewType=M","win","width=800, height=600");
	}
	
	function popExcelUpload(toDate, stdItem, viewType) {
		//window.open("http://10.101.164.228:8080/psupport/hourData.html?toDate=20171226&stdItem=TON00&viewType=M","win","width=800, height=600");
	}
	...
	function popExcelUpload(atchFileId, fileSn){
		window.open("<c:url value='/waterpolmnt/waterinfo/goKumhoExcelUpload.do'/>","excel","width=550px, height=130px, top=300px, left=300px");
	}
//]]>
</script>
</head>
				...
				<div id="content">
					...
					<form:form commandName="searchTaksuVO" name="listFrm"  id="listFrm" method="post">		
						...
						<div id="btArea">
							...
							<input type="button" id="btnBasic" name="btnBasic" class="btn btn_basic" onclick="javascript:popExcelUpload()" value="엑셀업로드" alt="엑셀업로드"/>
							<input type="button" id="btnExcel" name="btnExcel" class="btn btn_basic" onclick="javascript:popModeling()" value="모델링지도" alt="GIS모델링"/>
						</div>
