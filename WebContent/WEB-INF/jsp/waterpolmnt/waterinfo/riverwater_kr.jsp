...
<%
	/**
	 * Class Name : riverwater_kr.jsp
	 * Description : 금호강 일대 수질정보 실시간 조회 화면
...
<script type="text/javascript">
	...
	function popupGis(toDate, stdItem, viewType) {
		var toDate = $("#endDate").val2();
		window.open("/psupport/hourData.html?toDate="+toDate+"&stdItem=TON00&viewType=R","win","width=800, height=600");
	}
				...
				<div id="content">
					...
					<form:form commandName="searchTaksuVO" name="listFrm"  id="listFrm" method="post">		
						...
						<div id="btArea">
							...
							<input type="button" id="btnBasic" name="btnBasic" class="btn btn_basic" onclick="javascript:popupGis()" value="실시간지도" alt="GIS모델링"/>
