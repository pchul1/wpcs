				...
				<div class="inner_riverstat">
					...
					<form action="" onsubmit="return false">
						<dl>
							...
							<dd>
								<select class="fixWidth13" id="system" name="system" style="display:none">
										<option value="T" selected="selected">이동형측정기기</option>
								</select>
						...
						<dl>
							...
							<dd>
								<ul class="checkList">
									<li><input type="radio" class="inputRadio" id="" name="gubun" value="1" checked="checked" /><label for="">년간</label></li>
									<li><input type="radio" class="inputRadio" id="" name="gubun" value="2" /><label for="">분기</label></li>
									<li><input type="radio" class="inputRadio" id="" name="gubun" value="3" /><label for="">월간</label></li>
                                    <li><input type="radio" class="inputRadio" id="" name="gubun" value="4" /><label for="">일간</label></li>
								</ul>
							</dd>
								...
								<p class="part1">
                                   ...
                                   <select id="quarter" name="quarter" style="width:60px;">
                                    ...
                                    <select id="month" name="month" style="width:60px;"><option>12월</option>
									 ...
									 <select id="day" name="day" style="width:60px;"><option>30일</option>
									</select>
								</p>
							</dd>
						</dl>  
						<div class="btnInBox">
						  <dl>
							<dt>
								<span class="chekBoxSpan"><b>조회포함</b>&nbsp;<input type="checkbox" class="inputCheck" id="isCompare"/></span>						
							</dt>
							<dd>	
								<img src="<c:url value='/images/content/tit_search_branch2.gif'/>" alt="비교대상 측정소" />							
                    ...
                    <div class="showData">
                        ...
                        <p class="p_total_cnt2" id="statTitle"></p>
                        
                        <ul class="dataBtn">
							<li><img id="chart" src="<c:url value='/images/common/btn_graph.gif'/>" alt="그래프" style="display:none"/></li>
