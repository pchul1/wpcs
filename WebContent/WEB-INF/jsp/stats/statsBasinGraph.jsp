...
// 			systemName = "탁수모니터링";
		...
		function chart(){
			...
			var branch = factCode + "|" + $("#branchNo").val();
	...
	<center>
			...
			<ul class="selectList">
				<li><span class="buArrow_tit">측정소</span>
					<input type="hidden" id="system" value="${param.sysKind}"/>
					<input type="hidden" id="sugye" value="${param.sugye}"/>
					<input type="hidden" id="factCode" value="${param.factCode}"/>
					<select id="branchNo" style="width:140px">
					</select>
				</li>
