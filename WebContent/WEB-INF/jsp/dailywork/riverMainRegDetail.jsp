...
<%
	/**
	 * Class Name  : riverMainRegDetail.jsp
	 * Description : 4대강 주요 수계일지 화면
...
//<![CDATA[
	...
	function fnSave(){
		...
		if(confirm("저장 하시겠습니까?")){
			document.registform.action = "<c:url value='/dailywork/riverMainRegProc.do'/>";
								...
								<div>
									<table>
										...
										<tr>
											...
											<td>24시간</td>
											<td>
												<textarea name="situationteamContent1" id="situationteamContent1" rows="2" style="width:96%;"></textarea>
											</td>
											<td>
												<textarea name="situationteamContent2" id="situationteamContent2" rows="2" style="width:92%;"></textarea>
											</td>
										</tr>
										<tr>
											<td>수도권<p>동부</p></td>
											...
											<td>
												<textarea name="capitalAreaContent1" id="capitalAreaContent1" rows="2" style="width:96%;"></textarea>
											</td>
											<td>
												<textarea name="capitalAreaContent2" id="capitalAreaContent2" rows="2" style="width:92%;"></textarea>
											</td>
										</tr>
										<tr>
											<td rowspan="2">경북권</td>
											...
											<td>09:30~16:20</td>
											<td>
												<textarea name="gyeongbuk1Content1" id="gyeongbuk1Content1" rows="2" style="width:96%;"></textarea>
											</td>
											<td>
												<textarea name="gyeongbuk1Content2" id="gyeongbuk1Content2" rows="2" style="width:92%;"></textarea>
											</td>
										</tr>
										<tr>
											...
											<td>13:20~18:15</td>
											<td>
												<textarea name="gyeongbuk2Content1" id="gyeongbuk2Content1" rows="2" style="width:96%;"></textarea>
											</td>
											<td>
												<textarea name="gyeongbuk2Content2" id="gyeongbuk2Content2" rows="2" style="width:92%;"></textarea>
											</td>
										</tr>
										<tr>
											<td>충청권</td>
											...
											<td>10:00~17:00</td>
											<td>
												<textarea name="chungcheongContent1" id="chungcheongContent1" rows="3" style="width:96%;"></textarea>
											</td>
											<td>
												<textarea name="chungcheongContent2" id="chungcheongContent2" rows="3" style="width:92%;"></textarea>
											</td>
										</tr>
										<tr>
											<td>호남권</td>
											...
											<td>
												<textarea name="honamContent1" id="honamContent1" rows="3" style="width:96%;"></textarea>
											</td>
											<td>
												<textarea name="honamContent2" id="honamContent2" rows="3" style="width:92%;"></textarea>
											</td>
										</tr>
									</table>
								</div>
