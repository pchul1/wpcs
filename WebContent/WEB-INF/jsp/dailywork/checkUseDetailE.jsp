		...
		<div id="container">
			<div id="content_wrapper">
				...
				<div id="content">
					...
					<div >
						<span style="text-align:center;"><u><b><h1>진공흡입기/멀티콥터/방제바지선/에어텐트 (점검·사용) 일지</h1></b></u></span>
					</div>
						...
						<div class="table_wrapper">
							...
							<div>
								<%-- <c:if test="${checkUseVO.state == 'F'}"> --%>
									<input type="button" id="btnPrint" value="인쇄" class="btn btn_basic" style="float:right" alt="인쇄" onclick="javascript:fnPrint('E');"/>
								<%-- </c:if> --%>
