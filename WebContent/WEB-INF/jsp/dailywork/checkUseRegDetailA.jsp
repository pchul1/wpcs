				...
				<div id="content">
					...
					<div class="tab_container2">
						<div class="table_wrapper">
							...
							<br />
							<br />
							<span id="inputA1" style="float:left;display:none">
								<b>선박명</b> : 
							...
							<span id="inputA2" style="padding-left:30px;float:left;display:none"><b>계류장명</b> : 
								<c:forEach items="${equipList }" var="list">
							...
							<span id="spanUseVoyageSection" style="float:left;padding-left:50px;;display:none"><b>항해구간</b> : <input type="text" id="voyageSection" name="voyageSection" size="50"/></span>
							<span id="spanUseVoyageHour" style="padding-left:30px;float:left;display:none">
							...
							<div>
								<table id="accidentTable">
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none">
										...
										<td rowspan="8">선 박<br/>(${list.EQUIP_NAME })</td>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="01"/>
										<td rowspan="7">계류장<br/>(${list.EQUIP_NAME })</td>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="07"/>
										<td style="text-align:left;padding-left:5px;">계류장 주변환경</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
