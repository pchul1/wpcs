		...
		<div id="container">
			<div id="content_wrapper">
				...
				<div id="content">
					...
					<div>
						<span style="text-align:center;"><u><b><h1>방제창고·방제물품트레일러 점검 일지</h1></b></u></span>
					</div>
					...
					<div class="tab_container2">
						<div class="table_wrapper">
							...
							<div style="text-align:left;">
								...
								<input type="checkbox" name="reportGubun" id="reportGubunC1" value="C1" onclick="showHideRows(this,this.value)"/> 방제창고
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="checkbox" name="reportGubun" id="reportGubunC2" value="C2" onclick="showHideRows(this,this.value)"/> 방제물품트레일러
								</span> 
							</div>
							<br />
							<br />
							<span id="inputC1" style="float:left;display:none">
								<b>방제참고 시설명</b> : 
								<c:forEach items="${equipList }" var="list">
									<c:if test="${list.CHECK_GUBUN eq 'C1' }">
									<input type="checkbox" name="equipCode1" value="${list.EQUIP_CODE}" onclick="showHideRows(this,this.value)"/>${list.EQUIP_NAME } &nbsp;&nbsp;
									</c:if>
								</c:forEach>
							</span>
							<span id="inputC2" style="padding-left:30px;float:left;display:none"><b>방제물품트레일러 시설명</b> : 
								<c:forEach items="${equipList }" var="list">
									<c:if test="${list.CHECK_GUBUN eq 'C2' }">
									<input type="checkbox" name="equipCode2" value="${list.EQUIP_CODE}" onclick="showHideRows(this,this.value)"/>${list.EQUIP_NAME } &nbsp;&nbsp;
									</c:if>
								</c:forEach>
							</span>
							<div style="text-align:left;">
							...
							<div>
								<table id="accidentTable">
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none">
										...
										<td rowspan="17">방제창고<br/>(${list.EQUIP_NAME })</td>
										<td style="text-align:left;padding-left:5px;">주변옹벽 및 배수구 상태</td>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										...
										<td style="text-align:left;padding-left:5px;">지반 침하 상태</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										...
										<td style="text-align:left;padding-left:5px;">주변골재 균열 및 부식상태</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										...
										<td style="text-align:left;padding-left:5px;">주변청결 상태</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										...
										<td style="text-align:left;padding-left:5px;">담장 및 펜스 상태</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										...
										<td style="text-align:left;padding-left:5px;">출입문 잠금장치</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										...
										<td style="text-align:left;padding-left:5px;">무인 보안시스템 작동</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										...
										<td style="text-align:left;padding-left:5px;">창문 상태(시건장치 포함)</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										...
										<td style="text-align:left;padding-left:5px;">시설물 누수 및 균열여부</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="12"/>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="13"/>
										<td style="text-align:left;padding-left:5px;">소화기 비치 및 상태</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="14"/>
										<td style="text-align:left;padding-left:5px;">지붕상태(청결 등)</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="15"/>
										<td style="text-align:left;padding-left:5px;">벽면상태(청결 등)</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="16"/>
										<td style="text-align:left;padding-left:5px;">방제장비 재고량 일치</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none"">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="17"/>
										<td style="text-align:left;padding-left:5px;">방제물품 재고량 일치</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="01"/>
										<td rowspan="8">방제물품<br/>트레일러<br/>(${list.EQUIP_NAME })</td>
									...
									<tr id="equip${list.EQUIP_CODE }" style="display:none">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="06"/>
										<td style="text-align:left;padding-left:5px;">잠금장치</td>
										<td style="text-align:left;padding-left:10px;">
											<select name="checkResult">
												<!--<option value="">선택</option>-->
												<option value="O">양호</option>
