			...
			<div class="contentPad">
				...
				<div id="managePage">
					<ul class="menuList menuSpacing highIndex">
						<li class="spacing">
							<input type="button" value="좌표구하기" onclick="changeMode();"> 
							위도(Y) : <input id="laty" type="text" value="" style="width:70px;"/>
							경도(X) : <input id="lngx" type="text" style="width:70px;" value="" />
							주소 : <input id="addressPoint" type="text" value="" style="width:230px;"/>
