				...
				<div id="content">
					...
					<div class="tab_container">
							...
							<div class="table_wrapper">
								<table style="text-align:left" summary="그룹정보" >
									...
									<tr>
										...
										<td class="txtL"><input name="groupId" id="groupId" type="text" readonly value="<c:out value='${groupManage.groupId}'/>" size="40" /></td>
									</tr>
									<tr>  
									...
									<tr>
										<th>등록일자</th>
										<td class="txtL"><input name="groupCreatDe" id="groupCreatDe" type="text" value="<c:out value="${groupManage.groupCreatDe}"/>" required="true" fieldTitle="등록일자" maxLength="50" char="s" size="80" readonly/></td>
									</tr>
								</table>
							</div>
						...
						<div class="topBx">
							...
							<input type="button" id="btnGroupInsert" name="btnGroupInsert" value="등록" class="btn btn_basic" onclick="javascript:fncGroupInsert();" alt="등록" />
						</div>
						<!--top Search End-->
					</div>
					<!--tab Contnet End-->
