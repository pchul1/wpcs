...
//<![CDATA[
	...
	function fnModify(){
		...
		varForm.action = "<c:url value='/admin/cmmncode/CmmnCodeModify.do'/>";
	...
	function fnDelete(){
		if (confirm("<spring:message code="common.delete.msg" />")) {
			var varForm = document.all["Form"];
			varForm.action = "<c:url value='/admin/cmmncode/CmmnCodeRemove.do'/>";
			varForm.codeId.value = "${result.codeId}";
			varForm.submit();
		}
	}
							...
							<table summary="코드정보" style="text-align:left">
								...
								<tr>  
									...
									<td style="padding:4px">
										<textarea class="textarea" cols="130" rows="6" disabled="disabled">${result.codeIdDesc}</textarea>
									</td>
								</tr>
								<tr>
									<th>사용여부</th>
