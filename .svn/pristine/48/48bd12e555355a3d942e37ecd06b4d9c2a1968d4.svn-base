...
public class GaugeView extends AbstractView implements Ordered {

	/**
	 * @uml.property  name="log"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private Log log = LogFactory.getLog(GaugeView.class);
	...
	protected void renderMergedOutputModel(Map model,
		...
		Color markerColor = this.getPointColor(minOr);
	    ...
	    //Max값을 가져옵니다.
	    Double itemMax = ItemShape.getItemMax(itemCode);
	    
	    //Setting the MainScale
	    gauge.getMainScale().getBar().setVisible(true);
	    gauge.getMainScale().setMax(itemMax);
