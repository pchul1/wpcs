...
public class ExcelDetailViewRIVER extends AbstractExcelView{
	@Override
	protected void buildExcelDocument(Map model, HSSFWorkbook wb,
		...
		HSSFSheet sheet = wb.createSheet("이동형측정기기 조회 결과");
		...
		if("U".equals(searchTaksuVO.getSys()))
			filename = "이동형측정기기-"+ctime+".xls";
		else
			filename = "TUR_monitering-"+ctime+".xls";
