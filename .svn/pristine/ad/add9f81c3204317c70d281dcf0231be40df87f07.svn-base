...
public class WarningChartView extends AbstractView implements Ordered {
	/**
	 * @uml.property  name="log"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private Log log = LogFactory.getLog(WarningChartView.class);
	/**
	...
	protected void renderMergedOutputModel(Map model,
		...
		if(itemCodeList.size() > 1)
		{
			if("compare".equals(itemCodeList.get(1))){
				...
				chart1.getSeries().get(1).setColor(Color.RED);
			}
		}
