					...
					<div class="tab_container2">
						<div class="table_wrapper">
							...
							<div style="text-align:left;">
								...
								<input type="checkbox" name="reportGubun" id="reportGubunA1" value="C1" <c:if test="${fn:indexOf(checkUseVO.reportGubun , 'C1') > -1 }">checked="checked"</c:if> onclick="showHideRows(this,this.value)"/> 방제창고
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="checkbox" name="reportGubun" id="reportGubunA2" value="C2" <c:if test="${fn:indexOf(checkUseVO.reportGubun , 'C2') > -1 }">checked="checked"</c:if> onclick="showHideRows(this,this.value)"/> 방제물품트레일러
								</span> 
							</div>
							<br />
							<br />
							<span id="inputC1" style="float:left;<c:if test="${empty checkUseVO.equipCode1 }">display:none</c:if>">
								<b>방제참고 시설명</b> : 
							...
							<span id="inputC2" style="padding-left:30px;float:left;<c:if test="${empty checkUseVO.equipCode1 }">display:none</c:if>"><b>방제물품트레일러 시설명</b> : 
								<c:forEach items="${equipList }" var="list">
