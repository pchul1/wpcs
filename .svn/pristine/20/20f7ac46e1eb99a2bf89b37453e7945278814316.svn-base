...
//<![CDATA[
	...
	function fnPrint(printGubun) {
		...
		var param = "checkUseId=${checkUseVO.checkUseId}&gubun="+printGubun;
		...
		<div id="container">
			<div id="content_wrapper">
				...
				<div id="content">
					...
					<div >
						<span style="text-align:center;"><u><b><h1>방제창고·방제물품트레일러 점검일지</h1></b></u></span>
					</div>
					...
					<div class="tab_container2">
						<div class="table_wrapper">
							...
							<span style="padding-left:30px;float:left"><b>방제물품트레일러</b> : 
							...
							<div>
								<%-- <c:if test="${checkUseVO.state == 'F'}"> --%>
									<input type="button" id="btnPrint" value="인쇄" class="btn btn_basic" style="float:right" alt="인쇄" onclick="javascript:fnPrint('C');"/>
								<%-- </c:if> --%>
