		...
		<div id="container">
			<div id="content_wrapper">
				...
				<div id="content">
					...
					<input type="hidden" name="reportGubun" value="E1"/>
					<div>
						...
						<div class="table_wrapper">
							...
							<div>
								<table id="accidentTable">
									...
									<c:forEach items="${equipList }" var="list">
									<c:if test="${list.CHECK_GUBUN eq 'E1' }">
									...
									<c:forEach items="${equipList }" var="list">
									<c:if test="${list.CHECK_GUBUN eq 'E2' }">
									<tr id="equip${list.EQUIP_CODE }" style="display:none">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="01"/>
									...
									<c:forEach items="${equipList }" var="list">
									<c:if test="${list.CHECK_GUBUN eq 'E3' }">
									<tr id="equip${list.EQUIP_CODE }" style="display:none">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="01"/>
									...
									<c:forEach items="${equipList }" var="list">
									<c:if test="${list.CHECK_GUBUN eq 'E4' }">
									<tr id="equip${list.EQUIP_CODE }" style="display:none">
										<input type="hidden" name="gubunCode" value="${list.EQUIP_CODE }"/>
										<input type="hidden" name="checkCode" value="01"/>
