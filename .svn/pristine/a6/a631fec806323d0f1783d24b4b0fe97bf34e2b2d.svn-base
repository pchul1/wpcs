...
//  function SlickGrid(container, data, columns, options) {
  function SlickGrid(container, data, columnDefs, options) {	//이광복 수정. 20140226
    // settings
    var defaults = {
...
//    var $headerRow, $headerRowScroller, $headerRowSpacer;
    var $headerRow, $headerRowScroller, $headerRowSpacer, $spanHeaders;	//이광복 추가. 20140226
...
//    var columnPosRight = [];
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
    // Initialization
    function initializeColumns() {	//이광복 추가. 20140226
        //var lastIndex = 0;
    ...
    function init() {
      ...
      initializeColumns();	//이광복 추가. 20140226
      ...
      $spanHeaders = $("<div class='slick-header-columns' style='left:-1000px' />").appendTo($headerScroller);	//이광복 추가. 20140226
    ...
    function createColumnHeaders() {
      ...
      createSpanHeaderRow();	//이광복추가. 20140226      
    }

    //Method used to create Spanned header row
    function createSpanHeaderRow() {	//이광복 추가. 20140226
        if (!headerGrouping) {
            $spanHeaders.remove();
            return;
        }
