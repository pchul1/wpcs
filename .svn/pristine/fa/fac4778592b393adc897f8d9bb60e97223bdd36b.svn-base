...
this.imgURL = _editor_url + '/html/egovframework/cmm/utl/htmlarea/images/';
this.debug  = 0;
...
function editor_action(button_id) {
  ...
  // help popup
  if (cmdID == 'showhelp') {
    window.open(_editor_url + "/html/egovframework/cmm/utl/htmlarea/popups/editor_help.html", 'EditorHelp');
    return;
  }

  // popup editor
  if (cmdID == 'popupeditor') {
    window.open(_editor_url + "/html/egovframework/cmm/utl/htmlarea/popups/fullscreen.html?"+objname,
                'FullScreen',
  ...
  // Custom2
    ...
    var myText = showModalDialog(_editor_url + "/html/egovframework/cmm/utl/htmlarea/popups/custom2.html",
  ...
  // fgColor and bgColor
    ...
    var newcolor = showModalDialog(_editor_url + "/html/egovframework/cmm/utl/htmlarea/popups/select_color.html", oldcolor, "resizable: no; help: no; status: no; scroll: no;");
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert image
      ...
      showModalDialog(_editor_url + "/html/egovframework/cmm/utl/htmlarea/popups/insert_image.html", editdoc, "resizable: no; help: no; status: no; scroll: no; ");
    }

    // insert table
    else if (cmdID.toLowerCase() == 'inserttable'){
      showModalDialog(_editor_url + "/html/egovframework/cmm/utl/htmlarea/popups/insert_table.html?"+objname,
                                 window,
                                 "resizable: yes; help: no; status: no; scroll: no; ");
    }
...
function editor_setmode(objname, mode) {
 ...
 // src="' +_editor_url+ '/html/egovframework/cmm/utl/htmlarea/popups/blank.html"
...
function editor_about(objname) {
  showModalDialog(_editor_url + "/html/egovframework/cmm/utl/htmlarea/popups/about.html", window, "resizable: yes; help: no; status: no; scroll: no; ");
}
