package daewooInfo.admin.security.dao;
...
public class GroupManageDAO extends EgovAbstractDAO {
	...
	public List<HashMap<String, String>> selectGroupMember(String groupId) throws Exception {
		return list("groupManageDAO.selectGroupMember", groupId);
	}
	 ...
	 * @exception Exception
	 */
	public void insertGroupMember(EmpOnetouchSmsVO empOnetouchSmsVO) throws Exception {
		insert("groupManageDAO.insertGroupMember", empOnetouchSmsVO);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteGroupMember(GroupManage groupManage) throws Exception {
		delete("groupManageDAO.deleteGroupMember", groupManage);
	}
