			...
			<div class="content_wrap page_situationctl">
				<div class="inner_watersysmnt">
					<div class="watersysmnt_wrap">
						...
						<!--// areaTOver_watersysmnt_R01 -->
						<div id="areaTOver_watersysmnt_R01" class="areaTOver">
						...
						<div id="areaTHeader_top" >
							...
							<thead>
							<tr>
								<th scope="colgroup" colspan="5">측정항목</th>								
							</tr>
							<tr>
						...
						<div id="areaTHeader_left" style="overflow:hidden;float:left;clear:left;">
							...
							<%for(int i = 0 ; i < 20 ; i++) {%>
							<tr class="undefined">								
								<td class="num"><span id="">03</span></td>
								<td><span id="">이포보-1</span></td>
								<td><span id="">2010.10.26 22:00</span></td>
