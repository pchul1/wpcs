...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <br />
    <br />
    <table width="600" border="0" cellpadding="0" cellspacing="0" background="<c:url value='/images/util/blue_bg.jpg'/>">
      <tr>
        <td align="center"><table width="100%" border="0" cellspacing="9" cellpadding="0">
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left"><img src="<c:url value='/images/util/er_logo.jpg'/>" /></td>
              </tr>
              <tr>
                <td><br />
                  <br /></td>
              ...
              <tr>
                <td align="center"><table width="520" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    <td width="74" rowspan="2" align="center"><img src="<c:url value='/images/util/danger.jpg'/>" width="74" height="74" /></td>
              ...
              <tr>
                <td align="center"><a href="javascript:fncGoAfterErrorPage();"><img src="<c:url value='/images/util/go_history.jpg'/>" width="90" height="29" border="0" /></a></td>
              </tr> 
            </table>
              <br /></td>
          </tr>
