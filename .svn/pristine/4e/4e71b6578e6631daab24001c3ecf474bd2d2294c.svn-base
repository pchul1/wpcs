    ...
    */
    ...
    public LoginVO actionLogin(LoginVO vo) throws Exception {
    	...
    	if (loginVO != null && !loginVO.getId().equals("") && !loginVO.getPassword().equals("")) {
    		...
    		//System.out.println("YIK::::::vo.getId()::::::" + vo.getId());
    		//System.out.println("YIK::::::vo.getIp()::::::" + vo.getIp());    		
    		
    		// 접속한 아이피와 날짜(sysdate)를 업데이트 한다.
    		loginDAO.updateConnectInfo(vo);
    		loginDAO.insertConnectLogInfo(vo);
    		
    		vo.setWrongCount("0");
    	    this.loginDAO.updateWrongCount(vo);
    		
    		return loginVO;
    	} else {

            loginDAO.updateWrongCount(vo);
    		loginVO = new LoginVO();
    	}
	...
	public void updateWrongCount(LoginVO vo) throws Exception
	{
		this.loginDAO.updateWrongCount(vo);
	}

	public int getWrongCount(LoginVO loginVO) throws Exception
	{
			return this.loginDAO.getWrongCount(loginVO);
	}

	public LoginVO checkWrongCount(LoginVO vo) throws Exception
	{
		LoginVO loginVO = this.loginDAO.checkWrongCount(vo);
		return loginVO;
	}
	
	public String getAccountFindId(String uId) throws Exception {
		return loginDAO.getAccountFindId(uId);
	}
	
	public List<LoginVO> memberAuthorList(String uId) throws Exception{
		return loginDAO.memberAuthorList(uId);
	}
}
