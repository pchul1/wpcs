			...
			<div id="managePage">
				<form:form commandName="roleManage" method="post" >  
					<ul class="menuList menuSpacing">
						...
						<li>
							<a href="javascript:fncRoleUpdate()" style="selector-dummy:expression(this.hideFocus=false);" class="btn_mng"><span><em>수정</em></span></a>
						</li>
						<li>
							<a href="javascript:fncRoleDelete()" style="selector-dummy:expression(this.hideFocus=false);" class="btn_mng"><span><em>삭제</em></span></a>
						</li>
					</ul>
					<table class="dataTable">
						...
						<tr>
							...
							<td>
								<input name="roleCode" id="roleCode" type="text" readonly value="<c:out value='${roleManage.roleCode}'/>" size="30" readOnly />
							</td>
						</tr>
						<tr>  
