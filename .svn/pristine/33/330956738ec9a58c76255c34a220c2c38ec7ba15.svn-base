...
function resize() {
	...
	con_height = doc_height; //브라우저 - (상단+하단)
...
(function ($) {
	...
	$(document).ready(function () {
		...
		*/
		...
		//------------------------------------------------------------------------------------------
		$('#resultToggle').toggle(resultEnd, resultStart);
	...
	//------------------------------------------------------------------------------------------
	function schStart(){
	$('#leftSearchBx').animate({right:'-=306px'},200);
	
	$('#searchToggle img').attr('src','/gis/images/toggle_rout.png');
	$('#searchToggle img').attr('alt','열기');
	}
	function schEnd(){
		$('#leftSearchBx').animate({right:'+=306px'},200);
		
		$('#searchToggle img').attr('src','/gis/images/toggle_rin.png');
	 ...
	 */
	function schStartTm(){
		$('#leftSearchBx2').animate({right:'-=237px'},200);
