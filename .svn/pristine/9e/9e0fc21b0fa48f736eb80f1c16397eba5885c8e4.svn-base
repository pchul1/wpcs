...
public class EgovFileMngServiceImpl extends AbstractServiceImpl implements EgovFileMngService {
	...
	return fileMngDAO.selectVideoFileList(vo);
    }
    ...
    public String selectUploadFileName(String atchFileId) throws Exception {
    	return fileMngDAO.selectUploadFileName(atchFileId);
    }
    
    /**
     * 전체 파일을 삭제한다.
     * 
     * @see egovframework.com.cmm.service.EgovFileMngService#deleteAllFileInfs(String)
     */
    public void deleteAllFileInfs(String atchFileId) throws Exception {
	fileMngDAO.deleteAllFileInfs(atchFileId);
    }
}
