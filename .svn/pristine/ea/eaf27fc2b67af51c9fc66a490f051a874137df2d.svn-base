...
function fInsertMenuCreat() {
    ...
    document.menuCreatManageForm.action = "<c:url value='/admin/menu/EgovMenuCreatInsert.do'/>";
    document.menuCreatManageForm.submit(); 
}
/* ********************************************************
 * 메뉴사이트맵 생성 화면 호출
...
<body> 
<form name="menuCreatManageForm" action ="/admin/menu/EgovMenuCreatSelect.do" method="post">
