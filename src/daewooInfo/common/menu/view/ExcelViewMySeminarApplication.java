package daewooInfo.common.menu.view;
...
public class ExcelViewMySeminarApplication extends AbstractExcelView{
	@Override
	protected void buildExcelDocument(Map model, HSSFWorkbook wb,
		...
		//파일이름 설정
		String filename = "";
		filename = "MySeminarApplication.xls";
	    filename = new String(filename.getBytes("euc-kr"), "8859_1"); 
	    resp.setHeader("Content-Disposition", "attachment;filename="+filename+";"); 				
 
		HSSFSheet sheet = wb.createSheet("나의 교육등록 현황");
		sheet.setDefaultColumnWidth((short)18);
		
		String[] menu = {"번호","교육명", "교육기간", "교육시간", "교육장소", "담당자" , "연락처", "참여인원", "구분", "상태"};
