package daewooInfo.common;

import java.io.*;
import java.util.*;

/**
 *  Class Name : TmsProperties.java
 *  Description : properties값들을 파일로부터 읽어옴
 */
...
public class TmsProperties{
    ...
    = System.getProperty("user.home") + System.getProperty("file.separator") + "tmsProps"
