package daewooInfo.common.security.dao;
...
public class SecuredObjectDAO {
    ...
    +"  FROM T_ROLEINFO a, T_AUTHORROLERELATE b        "
    +"  WHERE a.ROLE_CODE = b.ROLE_CODE                "
    +"  AND a.ROLE_TYPE = 'url'  ORDER BY a.ROLE_SORT  ";
    ...
    public static final String DEF_ROLES_AND_METHOD_QUERY =
        ...
        +" FROM T_ROLEINFO a, T_AUTHORROLERELATE b                "
        +" WHERE a.ROLE_CODE = b.ROLE_CODE                        "
        +" AND a.ROLE_TYPE = 'method'  ORDER BY a.ROLE_SORT       ";    	
    ...
    public static final String DEF_REGEX_MATCHED_REQUEST_MAPPING_QUERY_ORACLE10G =
        ...
        + " FROM T_SECURED_RESOURCES a, T_SECURED_RESOURCES_ROLE b "
    ...
    */
    ...
    public static final String DEF_HIERARCHICAL_ROLES_QUERY =
        ...
        + "FROM T_ROLES_HIERARCHY a LEFT JOIN T_ROLES_HIERARCHY b on (a.child_role = b.parent_role) ";
