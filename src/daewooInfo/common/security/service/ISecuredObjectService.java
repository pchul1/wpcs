...
package daewooInfo.common.security.service;
...
public interface ISecuredObjectService {
	 ...
	 * @return  LinkedHashMap
	 * @exception Exception
	 * @uml.property  name="rolesAndMethod"
	 */
	 ...
	 * @return  LinkedHashMap
	 * @exception Exception
	 * @uml.property  name="rolesAndPointcut"
	 */
	 ...
	 * @return  String
	 * @exception Exception
	 * @uml.property  name="hierarchicalRoles"
	 */   
