package daewooInfo.common.security.userdetails.jdbc;
...
import daewooInfo.common.login.web.LoginController;
...
public class EgovJdbcUserDetailsManager extends JdbcUserDetailsManager {
	...
	/**
	 * @uml.property  name="userDetails"
	 * @uml.associationEnd  
	 */
	private TmsUserDetails userDetails = null;
    /**
	 * @uml.property  name="usersByUsernameMapping"
	 * @uml.associationEnd  
	 */
    private EgovUsersByUsernameMapping usersByUsernameMapping;
	
    /**
	 * @uml.property  name="mapClass"
	 */
    private String mapClass;
    /**
	 * @uml.property  name="roleHierarchy"
	 * @uml.associationEnd  
	 */
    ...
    protected void initDao() throws ApplicationContextException {
    	...
    	try {
    		...
    		log.error("EgovJdbcUserDetailsManager.initDao.ClassNotFoundException : " + e.toString(), e);
    	} catch (NoSuchMethodException e) {
    		log.error("EgovJdbcUserDetailsManager.initDao.NoSuchMethodException : " + e.toString(), e);
    	} catch (InstantiationException e) {
    		log.error("EgovJdbcUserDetailsManager.initDao.InstantiationException : " + e.toString(), e);
    	} catch (IllegalAccessException e) {
    		log.error("EgovJdbcUserDetailsManager.initDao.IllegalAccessException : " + e.toString(), e);
    	} catch (InvocationTargetException e) {
    		log.error("EgovJdbcUserDetailsManager.initDao.InvocationTargetException : " + e.toString(), e);
    	} catch (Exception e) {
    		log.error("EgovJdbcUserDetailsManager.initDao.Exception : " + e.toString(), e);
    	}
	...
	private void initMappingSqlQueries()
		...
		log.debug("## EgovJdbcUserDetailsManager query : " + getUsersByUsernameQuery());
	 ...
	 */
	@Override
	public TmsUserDetails loadUserByUsername(String username) throws UsernameNotFoundException, DataAccessException {
        ...
        this.userDetails = (TmsUserDetails) obj;
        ...
        return new TmsUserDetails(this.userDetails.getUsername(), this.userDetails.getPassword(), this.userDetails.isEnabled(), 
	 ...
	 * @throws DataAccessException
	 */
	public TmsUserDetails getAuthenticatedUser() throws UsernameNotFoundException, DataAccessException {
