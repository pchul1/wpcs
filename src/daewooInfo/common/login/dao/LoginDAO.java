...
public class LoginDAO extends EgovAbstractDAO {
	...
	public void insertConnectLogInfo(LoginVO vo) {
		insert("loginDAO.insertConnectLogInfo", vo);
	}
	
	public int getWrongCount(LoginVO loginVO) throws Exception
	{
		return (Integer)selectByPk("loginDAO.getWrongCount", loginVO);
	}
	
	public void updateWrongCount(LoginVO loginVO) throws Exception
	{
		update("loginDAO.updateWrongCount", loginVO);
	}
	
	public LoginVO checkWrongCount(LoginVO vo) throws Exception
	{
		return (LoginVO)selectByPk("loginDAO.checkWrongCount", vo);
	}

	public String getAccountFindId(String uId) throws Exception {
    	return (String)selectByPk("loginDAO.getAccountFindId", uId);
    }
	

	public List<LoginVO> memberAuthorList(String uId) throws Exception {
    	return list("loginDAO.memberAuthorList", uId);
    }
}
