...
public class PhGaugeView extends AbstractView implements Ordered {

	/**
	 * @uml.property  name="log"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private Log log = LogFactory.getLog(PhGaugeView.class);
	...
	protected void renderMergedOutputModel(Map model,
		...
		String lawMax = (String)model.get("lawMax");
		...
		if(lawVl == null || lawVl.trim().equals("-") || lawVl.trim().equals(""))
			lawVl = "0";
		if(lawMax == null || lawMax.trim().equals("-") || lawMax.trim().equals(""))
			lawMax = "0";
	    ...
	    gauge.getMainScale().setMin(5);
	    gauge.getMainScale().setMax(11);
...
//	    float value = Float.parseFloat(minVl);
	    float lawMin = Float.parseFloat(lawVl);
	    float lawMaxF = Float.parseFloat(lawMax);
//	    
//	    if(value >= lawMin && value <= lawMaxF)
...
//	    	markerColor = new Color(199,56,0);
	    ...
	    section1.getBar().setColor(new java.awt.Color(209,218,254));  // Color Aguamarine
	    section1.setMax(lawMaxF);
	    section1.setMin(lawMin);
