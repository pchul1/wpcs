...
public class EcGaugeView extends AbstractView implements Ordered {

	/**
	 * @uml.property  name="log"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private Log log = LogFactory.getLog(EcGaugeView.class);
...
//	    gauge.getMainScale().getTickmarks().getMajor().setStep(0.5);
